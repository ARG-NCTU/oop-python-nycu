...
class Shape:
    ...
    def resetCenter(self, center_x, center_y):
        self.center_x = center_x
        self.center_y = center_y
...
class Circle(Shape):
    ...
    def vertex_positions(self):
        return [(self.getCenterX() - self.radius, self.getCenterY()),
                (self.getCenterX(), self.getCenterY() - self.radius),
                (self.getCenterX() + self.radius, self.getCenterY()),
                (self.getCenterX(), self.getCenterY() + self.radius)]
