...
class Solution:
    def minScore(self, n: int, roads: List[List[int]]) -> int:
        ...
        min_score = math.inf    ##min_score is the maximum possible value, which is infinity
        s_par = dsu.find(0)
        ...
        return min_score    ##if they are not in the same set, then the distance is infinity
##this program gives the minimum distance between 1 and others
