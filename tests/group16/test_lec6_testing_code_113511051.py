...
def test_is_palindrome():
    ...
    assert lec6.is_palindrome('Able was I,  I was Able') == False
    assert lec6.is_palindrome('Is this not a palindrome') == False
    assert lec6.is_palindrome('ee') == True
...
def test_18_is_palindrome():
    assert lec6.is_palidrome('even') == False
    assert lec6.is_palindrome('Able was I, ere I saw Elba') == True
    assert lec6.is_palindrome('palindromeemordnilap') == True
    assert lec6.is_palindrome('eillie') == True
    assert lec6.is_palindrome('cool') == False
...
# please write a test for is_palindrome function
def test_is_palindrome():
    assert lec6.is_palindrome('evening') == False
    assert lec6.is_palindrome('Able was I, ere I saw Elba') == True
    assert lec6.is_palindrome('Is this a palindrome') == False
    assert lec6.is_palindrome('eillie') == True
    assert lec6.is_palindrome('cookieliileikooc') == True
...
def test_18_is_palindrome():
    ...
    assert lec6.is_palindrome('Able was I, ere I saw Elba') == True
    assert lec6.is_palindrome('Is this a palindrome') == False
    assert lec6.is_palindrome('eille') == False
    assert lec6.is_palindrome('cookieliileikooc') == True
