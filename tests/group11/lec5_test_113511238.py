...
def test_quotient_and_remainder_negative():
    assert lec5.quotient_and_remainder(-9, 2) == (-5, 1)
    assert lec5.quotient_and_remainder(9, -2) == (-5, -1)
...
def test_get_data():
    ...
    data4 = ((10, "mango"),)
    assert lec5.get_data(data4) == (10, 10, 1)
...
def test_sum_elem_methods():
    ...
    assert lec5.sum_elem_method2([0, 0]) == 0
...
def test_remove_dups_new_updated():
    L1 = [21, 22, 23, 24]
    L2 = [22, 25]
