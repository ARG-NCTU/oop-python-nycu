...
def test_is_palindrome():
    ...
    assert lec6.is_palindrome('Borrow or rob?') == True
    assert lec6.is_palindrome('Dammit I’m mad.') == True
    assert lec6.is_palindrome('Don’t nod.') == True
    assert lec6.is_palindrome('Rats live on no evil star.') == True
    assert lec6.is_palindrome('Was it a car or a cat I saw? ') == True
