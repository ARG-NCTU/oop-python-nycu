...
def test_get_ratios():
    ...
    result = lec7.get_ratios([1, 2, 3], [0, 2, 3])  # ZeroDivision
...
def test_get_stats():
    ...
    expected_output = [
        ...
        [["Lawrence Hsia"], [113, 10, 1018], 380.3333333333333],
        [["Johnny Chang"],  [113, 10, 1015], 379.3333333333333]
    ]
    assert lec7.get_stats(test_grades) == expected_output
