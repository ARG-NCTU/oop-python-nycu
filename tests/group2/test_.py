...
def test_2_greedy():
    ...
    #assert val == 10
    #assert Menu.get_foods_str(taken) == "donut: <20, 100>; "
def test_greedys():
    ...
    #assert val == 353.0 
    print(expected_str)
    #assert expected_str == "wine: <89, 123>; apple: <89, 123>; cola: <79, 150>; beer: <90, 154>; donut: <10, 195>; "
    ...
    #assert val == 318 
    print(expected_str)
    #assert expected_str == "wine: <89, 123>; beer: <90, 154>; cola: <79, 150>; apple: <50, 95>; donut: <10, 195>; "
