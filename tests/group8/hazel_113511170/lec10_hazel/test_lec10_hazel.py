...
def test_linear_search():
    ...
    assert lec10.linear_search([2, 3, 4, 5, 6], 7) == False
    assert lec10.linear_search([], 10) == False

def test_linear_search_int_list(sample_data):
    assert lec10.linear_search(sample_data, 3) == True 
    assert lec10.linear_search(sample_data, 10) == False
...
def test_linear_search_int_list():
    assert lec10.linear_search(int_list(10), 12) == False
