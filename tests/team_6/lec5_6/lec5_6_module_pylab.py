...
def plot_mean_distances(walk_lengths, mean_distances):
    pylab.figure()
    pylab.plot(walk_lengths, mean_distances)
...
if __name__ == '__main__':
    ...
    usual_drunk_distances = sim_drunk(num_trials, UsualDrunk, walk_lengths)
    plot_mean_distances(walk_lengths, usual_drunk_distances)
