...
import add_path
from src.mit_ocw_exercises.lec6_recursion_dictionaries import fib, is_palindrome, lyrics_to_frequencies, fib_mem, fib_efficient
...
#     d = {1:1, 2:2}
#     for n in range(1, 35):
#         assert fib_mem(n) == fib_efficient(n, d)